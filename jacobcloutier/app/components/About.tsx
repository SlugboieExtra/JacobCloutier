    ...
    <div className="bg-gradient-to-b from-white-300 to-white-500 w-full py-14">
      <div className="max-w-screen-xl  px-6 sm:px-8 lg:px-16 mx-auto flex flex-col w-full text-center justify-center">
        <div className="grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-2 gap-8 p  y-8 my-12">
          <ScrollAnimationWrapper className={"flex flex-col justify-center items-start row-start-2 sm:row-start-1"}>
            <motion.h3
              variants={scrollAnimation}
              className="text-2xl text-left sm:text-3xl lg:text-4xl font-medium text-black-600 leading-relaxed">
              About Jacob Cloutier
            </motion.h3>
            <motion.p className="leading-normal text-left mx-auto my-2" variants={scrollAnimation}>
          ...
          <ScrollAnimationWrapper>
            <motion.div className="py-12 w-full" variants={scrollAnimation}> 
            ...
            <motion.div variants={scrollAnimation} custom={{duration: 3}}>
              <div className="bg-yellow-500 rounded-xl py-8 sm:py-14 px-6 sm:px-12 lg:px-16 w-full">
                ...
                <div className="flex mx-auto mt-10 w-10/12 sm:w-7/12 lg:w-6/12">
                  <ButtonPrimary addClass={'w-full '} href='https://forms.gle/xMjUbrpwHFntMVPA9'>Get Started</ButtonPrimary>
                </div>
              </div>
            </motion.div>
          </ScrollAnimationWrapper>
